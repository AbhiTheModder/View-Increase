...
██║██║ ╚████║╚██████╗██║  ██║███████╗██║  ██║███████║███████╗
╚═╝╚═╝  ╚═══╝ ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚══════╝╚══════╝ /\n";
echo "$merah / CreatedBy : ABHI (Subscribe Now) /\n";
echo "$magenta / YOUTUBE   : https://www.youtube.com/channel/UCtBILuQgvXHPfvOUdcmMS2Q /\n";
echo "$cyan ###################################################\n";
echo "$kuning Enter URL of your website or Blog\n or Enter Url of page which you want to increase view\n";
echo "$hijau [1] Link or URL of your Website : "; 
...
for($i = 1; $i < $max+1; $i++) {
	...
	echo $i.". View Added by Abhi ~ [".$class->jalankan()."]\n";
}
